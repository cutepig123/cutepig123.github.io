...
一个boost：：any的增强版，支持dynamic cast
...
**Anders Hejlsberg**讲了CORBA，IIOP，对象请求代理面临的问题。ORM的问题
...
[inheritance-is-procedural](https://www.yegor256.com/2016/09/13/inheritance-is-procedural.html)

我们都知道[继承](https://en.wikipedia.org/wiki/Inheritance_(object-oriented_programming))是不好的，[继承](https://en.wikipedia.org/wiki/Inheritance_(object-oriented_programming))[之上的组合](https://en.wikipedia.org/wiki/Composition_over_inheritance)是一个[好主意](http://programmers.stackexchange.com/questions/65179)，但是我们真的理解为什么吗. 本文尝试解释原因

*子类型化*，这是一种完美的技术

实现继承的[含义](http://www.oxforddictionaries.com/us/definition/american_english/inherit)更接近：“将（金钱，财产或头衔）作为前任持有人去世的继承人来接收。” 你问谁死了？如果对象允许其他对象*继承*其封装的代码和数据，则该对象将失效。这是实现继承
...
[ GitHub - Dreamacro/clash: A rule-based - in Go. ]( https://github.com/Dreamacro/clash ) 2021-02-12 16:09:23.027145
