测了一下[autocxx](https://github.com/google/autocxx)

autocxx是在cxx基础上的一个让他更方便的包装
...
我的测试平台为linux，在windows下面不如linux下面好搞
...
```rust
//Z:\autocxx\target\debug\build\autocxx-demo-c7f5eb35fa8eb422\out\autocxx-build-dir\rs\autocxx-ffi-default-gen.rs
...
mod ffi {
    ...
    unsafe impl cxx::ExternType for bindgen::root::Goat {
        type Id = cxx::type_id!("Goat");
    ...
    mod bindgen {
        pub(super) mod root {
            ...
            impl Goat {
                pub fn describe(self: &root::Goat) -> cxx::UniquePtr<cxx::CxxString> {
                    cxxbridge::describe_autocxx_wrapper(self)
                }
                ...
                pub fn make_unique() -> cxx::UniquePtr<root::Goat> {
                    cxxbridge::make_unique_autocxx_wrapper()
                }
            }
            impl Drop for root::Goat {
                fn drop(self: &mut root::Goat) {
                    unsafe { cxxbridge::Goat_destructor_autocxx_wrapper(self) }
                }
            }
            unsafe impl autocxx::moveit::MakeCppStorage for root::Goat {
                unsafe fn allocate_uninitialized_cpp_storage() -> *mut root::Goat {
                    cxxbridge::Goat_alloc_autocxx_wrapper()
                }
                unsafe fn free_uninitialized_cpp_storage(arg0: *mut root::Goat) {
                    cxxbridge::Goat_free_autocxx_wrapper(arg0)
                }
            }
            unsafe impl autocxx::moveit::new::CopyNew for root::Goat {
                unsafe fn copy_new(
                    other: &root::Goat,
                    this: ::std::pin::Pin<&mut ::std::mem::MaybeUninit<root::Goat>>,
                ) {
                    cxxbridge::new_synthetic_const_copy_ctor_autocxx_wrapper(
    ...
    mod cxxbridge {
        ...
        unsafe extern "C++" {
            ...
            pub unsafe fn Goat_alloc_autocxx_wrapper() -> *mut Goat;
            pub unsafe fn Goat_free_autocxx_wrapper(arg0: *mut Goat);
            type Goat = super::bindgen::root::Goat;
            pub fn add_a_horn(self: Pin<&mut Goat>);
            pub fn describe_autocxx_wrapper(autocxx_gen_this: &Goat) -> UniquePtr<CxxString>;
            pub unsafe fn new_autocxx_autocxx_wrapper(autocxx_gen_this: *mut Goat);
            pub unsafe fn Goat_destructor_autocxx_wrapper(autocxx_gen_this: *mut Goat);
            pub fn DoMath(a: u32) -> u32;
            pub unsafe fn new_synthetic_const_copy_ctor_autocxx_wrapper(
                autocxx_gen_this: *mut Goat,
                other: &Goat,
            );
            pub fn make_unique_autocxx_wrapper() -> UniquePtr<Goat>;
            include!("input.h");
    ...
    #[allow(unused_imports)]
    use bindgen::root;
    pub use cxxbridge::autocxx_make_string as make_string;
    pub use cxxbridge::DoMath;
    pub use cxxbridge::Goat;
}
...
```cpp
// Z:\autocxx\target\debug\build\autocxx-demo-c7f5eb35fa8eb422\out\autocxx-build-dir\include\autocxxgen_ffi.h
...
inline std::unique_ptr<std::string> autocxx_make_string(::rust::Str str) { return std::make_unique<std::string>(std::string(str)); }
inline Goat* Goat_alloc_autocxx_wrapper()  { return new_appropriately<Goat>(1);; }
inline void Goat_free_autocxx_wrapper(Goat* arg0)  { delete_appropriately<Goat>(arg0);; }
inline std::unique_ptr<std::string> describe_autocxx_wrapper(const Goat& autocxx_gen_this)  { return std::make_unique<std::string>(autocxx_gen_this.describe()); }
inline void new_autocxx_autocxx_wrapper(Goat* autocxx_gen_this)  { new (autocxx_gen_this) Goat(); }
inline void Goat_destructor_autocxx_wrapper(Goat* arg0)  { arg0->~Goat(); }
inline void new_synthetic_const_copy_ctor_autocxx_wrapper(Goat* autocxx_gen_this, const Goat& arg1)  { new (autocxx_gen_this) Goat(arg1); }
inline std::unique_ptr<Goat> make_unique_autocxx_wrapper()  { return std::make_unique<Goat>(); }
